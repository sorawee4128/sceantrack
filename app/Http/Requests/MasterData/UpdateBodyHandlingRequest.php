...
class UpdateBodyHandlingRequest extends FormRequest
{
    ...
    {
        $routeParam = $this->route('body_handling')
            ?? $this->route('bodyHandling')
            ?? $this->route('id');
        ...
        return [
            'code' => [
                ...
                'string',
                'max:50',
                Rule::unique('body_handlings', 'code')->ignore($id),
            ],
    ...
    {
        return [
            'name.required' => 'กรุณากรอกชื่อการจัดการศพ',
