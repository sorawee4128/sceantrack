<div class="grid gap-4 md:grid-cols-2">
    ...
    <div>
        ...
        <select name="shift_type" class="input">
            ...
            <option value="day" @selected(old('shift_type', $shift->shift_type->value ?? '') === 'day')>กะกลางวัน</option>
            <option value="night" @selected(old('shift_type', $shift->shift_type->value ?? '') === 'night')>กะกลางคืน</option>
        </select>
    </div>
    <div>
        <label class="label">Doctor</label>
        <select name="doctor_user_id" class="input">
            <option value="">-- เลือก doctor --</option>
    ...
    <div>
        ...
        <select name="assistant_user_id" class="input">
            <option value="">-- เลือก assistant --</option>
