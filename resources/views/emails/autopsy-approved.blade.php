...
<body style="margin:0; padding:0; background:#f1f5f9; font-family:'Sarabun','Tahoma','Noto Sans Thai',sans-serif; color:#0f172a;">
    <div style="max-width:680px; margin:0 auto; padding:32px 16px;">
        <div style="background:#ffffff; border-radius:18px; padding:28px; border:1px solid #e2e8f0;">
            <div style="text-align:center; margin-bottom:24px;">
                ...
                <h2 style="margin:0; font-size:22px; color:#0f172a; font-family:'Sarabun','Tahoma','Noto Sans Thai',sans-serif;">
                    แจ้งความคืบหน้ารายงานตรวจศพทางนิติเวชศาสตร์
                </h2>
                <p style="margin:6px 0 0; color:#64748b; font-family:'Sarabun','Tahoma','Noto Sans Thai',sans-serif;">
                    โรงพยาบาลภูมิพลอดุลยเดช กรมแพทย์ทหารอากาศ
                </p>
            </div>

            <div style="background:#f8fafc; border-radius:14px; padding:18px; margin-bottom:20px; font-family:'Sarabun','Tahoma','Noto Sans Thai',sans-serif;">
            ...
            <p style="line-height:1.7; margin:0 0 16px; font-family:'Sarabun','Tahoma','Noto Sans Thai',sans-serif;">
            ...
            <div style="border-top:1px solid #e2e8f0; margin-top:24px; padding-top:16px; color:#64748b; font-size:14px; line-height:1.6; font-family:'Sarabun','Tahoma','Noto Sans Thai',sans-serif;">
